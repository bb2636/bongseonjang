...
export function OrderManagementPage() {
  ...
  const renderPaymentMethod = (method: PaymentMethod) => paymentMethodLabelMap[method];

  return (
    <AdminLayout title="주문 관리" description="사용자의 주문 현황을 한눈에 확인하고 관리합니다">
      <div className="order-management">
        <div className="order-management__hero">
          <div>
            <h2 className="order-management__title">주문 관리</h2>
            <p className="order-management__subtitle">사용자의 주문 현황을 관리합니다</p>
          </div>
          <div className="order-management__summary">
            ...
            <span className="order-management__summary-count">{orders.length.toString().padStart(4, '0')}</span>
          </div>
        </div>
